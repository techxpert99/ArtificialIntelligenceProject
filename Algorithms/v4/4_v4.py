...
root = 'C:/Users/Ritik/Desktop/2021 Autumn Semester/Assignments/AI/classifiers/v4/'
with open(root+'train.pickle','rb') as f: wtwd = load(f)
...
with open(root+'distributions/T_WW.pickle',mode='wb') as file:
    dump(t_wwd,file)
